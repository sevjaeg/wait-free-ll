...
% ??? Finally, an attempt to compare the latencies of the wait-free and lock-free list was undertaken.

%machine
%compiler version

% BM1 : focus on operation phase (low fill, high iterations)

% BM2: only fill/empty

% CAS failure counting scheme: count the same operations (no CAS of state array for wf)
% add: link in
% del: logical removal
% find: physical removal
